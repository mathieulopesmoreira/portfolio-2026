  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "SAS", tooltip: "Programmation SAS pour l'extraction, la manipulation et l'analyse de données." },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "BO", tooltip: "SAP BusinessObjects pour la création de rapports et l'analyse décisionnelle." },
        { name: "SAS VA", tooltip: "SAS Visual Analytics pour l'exploration de données et le reporting interactif." },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Self-hosting", tooltip: "Déploiement de services personnels sur infrastructure propre." },
        ...
        { name: "JavaScript", tooltip: "Scripting et logique de programmation pour le développement web." },
      ],
    },
  ];
